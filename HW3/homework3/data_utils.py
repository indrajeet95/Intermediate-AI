    ...
    def sentences(self):
        ...
        with open(self.path + "/datasetSentences.txt", "r") as f:
            ...
            for line in f:
                ...
                #if line.strip().split()[0] == "5955":
                #    print (" ".join([w.lower() for w in splitted]))
    ...
    def sent_labels(self):
        ...
        with open(self.path + "/dictionary.txt", "r") as f:
            for line in f:
                ...
                if splitted[1] == "103716":
                    debug_sent = splitted[0].lower() 
                    print ("DICT0", splitted[0].lower())
                phrases += 1
        ...
        for i in range(self.numSentences()):
            ...
            if i == 5954:
                print ("SENT1", " ".join(sentence)) 
                print ("SENT2", "'", full_sent.encode('utf8'), "'") 
                print ("SENT3", "'", debug_sent.encode('utf8'), "'") 
                print (dictionary[debug_sent])
                if full_sent != debug_sent:
                    print ("same!")
